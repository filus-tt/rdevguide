...
Por supuesto, Filus. Los entornos largos están diseñados precisamente
para eso.
...
\chapter{Capítulo 1}\label{capuxedtulo-1-1}
...
\section{Código de ejemplo}\label{cuxf3digo-de-ejemplo-1}
...
\section{Continuando con texto
normal}\label{continuando-con-texto-normal-1}
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-color-frame, breakable, bottomrule=.15mm, leftrule=.75mm, opacityback=0, rightrule=.15mm, arc=.35mm, left=2mm, colback=white, toprule=.15mm]
