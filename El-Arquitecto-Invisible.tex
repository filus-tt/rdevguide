...
% --- Entorno para ADVERTENCIA (Tipografía Sans-Serif) ---
\newtcolorbox{advertencia}{
  ...
  fontupper=\sffamily, % <-- CAMBIO: De monoespaciada a sans-serif
  left=10mm,
  right=5mm,
  top=5mm,
  bottom=5mm,
...
% --- Entorno para CONCLUSIÓN (Tipografía Sans-Serif) ---
...
\item
  ...
  programa.
\item
  Si estás dispuesto a aceptar tu rol de componente en algo más grande,
  esta teoría será un bálsamo. \textgreater{} Te liberará de la carga de
  tu propia historia.
\end{itemize}
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, rightrule=.15mm, bottomrule=.15mm, toprule=.15mm, colframe=quarto-callout-color-frame, colback=white, breakable, left=2mm, arc=.35mm, leftrule=.75mm]
